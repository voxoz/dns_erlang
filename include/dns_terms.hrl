...
-define(DNS_TLSA_CERTUSAGE_CACONSTRAINT, 0).
-define(DNS_TLSA_CERTUSAGE_SCCONSTRAINT, 1).
-define(DNS_TLSA_CERTUSAGE_TAASSERTION, 2).
-define(DNS_TLSA_CERTUSAGE_DICERT, 3).
-define(DNS_TLSA_CERTUSAGE_PRIVATE, 255).
-define(DNS_TLSA_SELECTOR_FULL, 0).
-define(DNS_TLSA_SELECTOR_SUBJECTPUBKEYINFO, 1).
-define(DNS_TLSA_SELECTOR_PRIVATE, 255).
-define(DNS_TLSA_MT_NOHASH, 0).
-define(DNS_TLSA_MT_SHA256, 1).
-define(DNS_TLSA_MT_SHA512, 2).
-define(DNS_TLSA_MT_PRIVATE, 255).
...
-define(DNS_TYPE_TLSA, ?DNS_TYPE_TLSA_NUMBER).
-define(DNS_TYPE_TLSA_NUMBER, 52).
-define(DNS_TYPE_TLSA_BSTR, <<"TLSA">>).
